...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Добавьте игрушки для розыгрыша");
        System.out.println("************************************************");
       ...
       while (remainder > 0){
           ...
           tempIdToy++;
            ...
            System.out.println();
            System.out.println("************************************************");
            System.out.println("База данных готова для участия в розыгрыше:");
       for (int i = 1; i < tempIdToy ;i++){
           System.out.println(toys[i].idToy + " - " + toys[i].weightToy + " - " + toys[i].nameToy);
            ...
            try {
                ...
                int num;
                System.out.println("************************************************");
                System.out.print("Сколько этапов розыгрыша: ");
                ...
                pw.close();
                System.out.println("************************************************");
                System.out.println("Итоги проведения розыгрыша найдёте в файле itog.txt");
            } catch (IOException e) {
